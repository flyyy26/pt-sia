...
<div class="section_1_wim">
    ...
    <img src="images/wim_heading.svg" alt="WIM Sensor Fiber Optic" class="heading_wim_img">
    <img src="images/wim_product_icon.svg" alt="WIM Sensor Fiber Optic" class="icon_wim">
    <div class="p_wim">
        <img src="images/quote_left.svg" alt="WIM Description" class="quote_left">
        <img src="images/quote_right.svg" alt="WIM Description" class="quote_right">
...
<div class="section_2_wim">
    <div class="section_2_wim_img">
        <img src="images/wim_section_2.png" alt="WIM Sensor Fiber Optic">
    </div>
        ...
        <?php foreach ($keunggulans as $keunggulan): ?>
            <div class="section_2_wim_box">
                <div class="section_2_wim_box_icon">
                    <img src="<?= $keunggulan['icon']; ?>" alt="<?= $keunggulan['alt']; ?>">
                </div>
    ...
    <div class="section_6_wim_wrapper">
        <div class="section_6_wim_container">
            <div class="section_6_wim_content_img">
                <img src="images/pelat_lentur.png" alt="Pelat Lentur">
            </div>
        ...
        <div class="section_6_wim_container">
            <div class="section_6_wim_content_img">
                <img src="images/data_logger.png" alt="Data Logger">
            </div>
            <div class="section_6_wim_content_layout">
                <h4>Data Logger</h4>
...
<div class="section_8_wim">
    ...
    <div class="section_8_wim_container">
        <div class="section_8_wim_layout_1">
            <img src="images/vector_top.png" alt="Line" class="vector_top">
            <img src="images/vector_top_2.png" alt="Line" class="vector_top_2">
            <h1 class="heading_number_1">1</h1>
            <div class="section_8_wim_img_1">
                <img src="images/diff_1.png" alt="Re-Usable">
            </div>
        ...
        <div class="section_8_wim_layout_2">
            ...
            <img src="images/vector_top_3.png" alt="Line" class="vector_top_3">
            ...
            <div class="section_8_wim_img_1">
                <img src="images/diff_2.png" alt="Instalasi yang mudah dan tidak invasif">
            </div>
        </div>
        <div class="section_8_wim_layout_3">
            <h1 class="heading_number_3">3</h1>
            <img src="images/vector_top_4.png" alt="Line" class="vector_top_4">
        ...
        <div class="section_8_wim_layout_4">
            ...
            <img src="images/vector_top_5.png" alt="Line" class="vector_top_5">
        ...
        <div class="section_8_wim_layout_3">
            ...
            <img src="images/vector_top_6.png" alt="Line" class="vector_top_6">
            <div class="section_8_wim_img_1" style="background-color:silver;">
                <img src="images/diff_5.png" alt="Integrasi yang mudah dengan perangkat ITS (Intelligent Transportation System) lainnya">
            </div>
    ...
    <div class="section_8_wim_banner">
        <img src="images/intelejen.webp" alt="Intellegent Banner">
    </div>
</div>
